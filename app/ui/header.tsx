  ...
  return <header className="header">
    ...
    <nav className={open?"nav open":"nav"} aria-label="Navigation principale">
      <div className="services-menu">
        <Link href="/services" onClick={closeMenu}>Services <span aria-hidden="true">⌄</span></Link>
        <div className="services-submenu" aria-label="Navigation des services">
          <Link href="/services" onClick={closeMenu}>Tous les services</Link>
          <Link href="/#services" onClick={closeMenu}>Aperçu sur l’accueil</Link>
        </div>
      </div>
      <Link href="/services/demenagement" onClick={closeMenu}>Déménagement</Link><Link href="/services/nettoyage" onClick={closeMenu}>Nettoyage</Link><Link href="/services/location-camion" onClick={closeMenu}>Location camion</Link><Link className="reviews-nav-link" href="/avis" onClick={closeMenu}>Avis <span className="reviews-count" aria-label={`${testimonials.length} avis`}>{testimonials.length}</span></Link><Link href="/#contact" onClick={closeMenu}>Contact</Link>
    </nav>

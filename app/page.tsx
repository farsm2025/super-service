...
const services = [
  ...
  { icon: "▰", title: "Location de camion", text: "Louez un camion sans chauffeur à Lausanne pour votre déménagement, vos meubles, cartons et objets volumineux.", href: "/services/location-camion" },
...
export default function Home() {
  return <main>
    ...
    <section className="section intro" id="services">
      ...
      <aside className="truck-highlight"><div className="truck-highlight-image"><Image src="/images/location-camion/camion-exterieur.webp" alt="Location de camion sans chauffeur à Lausanne" fill sizes="(max-width:900px) 100vw,50vw"/></div><div><p className="eyebrow light">Nouveau service</p><h3>Besoin d’un camion sans chauffeur ?</h3><p>Organisez votre transport à votre rythme avec un véhicule offrant un grand espace de chargement.</p><Link className="button button-white" href="/services/location-camion">Découvrir la location</Link></div></aside>
    </section>

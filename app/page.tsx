...
const services = [
  ...
  { icon: "▰", title: "Location de camions", text: "Deux volumes au choix : Iveco Daily 17 m³ ou Citroën Jumper 20 m³ avec hayon, sans chauffeur.", href: "/services/location-camion" },
...
export default function Home() {
  return <main>
    ...
    <section className="section intro" id="services">
      ...
      <aside className="truck-highlight"><div className="truck-highlight-image"><Image src="/images/location-camion/citroen-jumper-exterieur.webp" alt="Deux camions à louer sans chauffeur à Lausanne" fill sizes="(max-width:900px) 100vw,50vw"/></div><div><p className="eyebrow light">Deux véhicules disponibles</p><h3>17 m³ ou 20 m³ avec hayon</h3><p>Choisissez entre l’Iveco Daily et le Citroën Jumper pour organiser votre transport à votre rythme.</p><Link className="button button-white" href="/services/location-camion">Comparer les véhicules</Link></div></aside>
    </section>
